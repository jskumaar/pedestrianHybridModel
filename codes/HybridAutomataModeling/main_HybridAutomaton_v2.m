...
% 7.5 m calculated from 95th percentile of pedestrian position when the
% approach to wait/cross gap starts
...
filename = strcat('Performance_Hybrid_',num2str(pred_Horizon_matrix(gg)-1),'_SVM_StartGap.mat');
