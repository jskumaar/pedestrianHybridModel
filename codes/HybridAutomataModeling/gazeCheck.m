...
function isLooking = gazeCheck(carPosPixels, pedPosPixels, car_heading_cell, ped_heading_cell)
...
carEdgePoints = carPosPixels + [rot_car*[-carOverallLength_pixels, carOverallWidth_pixels;
                                         ...
                                         carOverallLength_pixels, -carOverallWidth_pixels;
                                        -carOverallLength_pixels, -carOverallWidth_pixels]']';
% create a polygon object for the car's box
...
if ~isempty(intersectingRegion.Vertices)
    isLooking = true;
else
    isLooking = false;   
end
