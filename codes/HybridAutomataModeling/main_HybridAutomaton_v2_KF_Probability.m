%% This is the main file to run the hybrid automaton where the state transitions are based on the probabilty distributions
% The continuous motion is given by a Constant velocity Kalman Filter with
% Gaussian Noise
%% Updated: 10/28/19
% The new featutes and SVM model files replaced the old ones thinking this
% was the file for the SVM based state transitions (My Bad!)

clear all

%addpath
addpath('G:\My Drive\Research\1. Pedestrian Modelling Project - VR simulation\Modelling Scripts and Results\1. Study I Data for Modeling\Compiled Data')
addpath('G:\My Drive\Research\1. Pedestrian Modelling Project - VR simulation\Modelling Scripts and Results\2. Mat Data')
addpath('G:\My Drive\Research\1. Pedestrian Modelling Project - VR simulation\Modelling Scripts and Results\Scripts - HybridModel\Hybrid Automaton\Discrete Transition Models\SVM Models')
