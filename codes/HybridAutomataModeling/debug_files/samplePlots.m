...
% unique predictions
[FSR_MHP_unique, unique_rows] = unique(FSR_MHP,'rows');
...
% plot average displacement error
figure()
plot(timeStep,MeanFSR_MHP + MeanFRS_MHP_add,'-*b','MarkerSize',markSize,'LineWidth',lineThickness);hold on;
plot(timeStep,MeanFSR_HBase + MeanFRS_HBase_add,'-*k','MarkerSize',markSize,'LineWidth',lineThickness);hold on;
plot(timeStep,MeanFSR_CV + MeanFRS_CV_add,'-*r','MarkerSize',markSize,'LineWidth',lineThickness);hold on;
legend('MHP','Hybrid','Constant velocity')
title('inD - FRS Ratio')
xlabel('Prediction Horizon [s]')
ylabel ('FRS Ratio')
...
% plot average displacement error
figure()
plot(timeStep,MeanLL_MHP + MeanLL_MHP_add,'-*b','MarkerSize',markSize,'LineWidth',lineThickness);hold on;
plot(timeStep,MeanLL_HBase + MeanLL_HBase_add,'-*k','MarkerSize',markSize,'LineWidth',lineThickness);hold on;
