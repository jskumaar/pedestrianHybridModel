...
function currentPedTrackData = func_egoCarFunc(currentPedTrackData, activeCarTracksData, carTrackCurrentTimeStep, cw, annotatedImageEnhanced, Params, predTimeStep, reset)
...
%      isLooking = isLooking || isLookingTemp;
    ...
    if ( abs(pedHeading - carHeading) < 45  || abs(pedHeading - carHeading) > 315 )  
