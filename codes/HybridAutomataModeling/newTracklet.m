...
function [data, kfData, probability, startNode, endNode, isActive, eventFlag, Goal, newTrackletId, flag, resetFlag] = newTracklet(data, kfData, probability, startNode, endNode, isActive, eventFlag, Goal, node_no, prob_tracklet, currentTrackletId, parentTrackletId, flag)
    % new tracklet id
