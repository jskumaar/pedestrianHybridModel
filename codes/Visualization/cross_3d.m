...
for ii=1:length(gaze_cross)
                ...
                if(~isempty(strfind(gaze_cross{ii,2},'Traffic'))||~isempty(strfind(gaze_cross{ii,3},'Traffic')))
                    scatter3(str2double(gaze_cross_position(ii,2)),str2double(gaze_cross_position(ii,3)),str2double(gaze_cross_position(ii,4)),'r');
                    hold on;
                
                     
                %check for Ped light
                else if(~isempty(strfind(gaze_cross{ii,2},'Ped'))||~isempty(strfind(gaze_cross{ii,3},'Ped')))
                     scatter3(str2double(gaze_cross_position(ii,2)),str2double(gaze_cross_position(ii,3)),str2double(gaze_cross_position(ii,4)),'b');
                      hold on;               
%                     
                %check for vehicles
                    else if(~isempty(strfind(gaze_cross{ii,2},'Vehicle'))||~isempty(strfind(gaze_cross{ii,3},'Vehicle')))
                     scatter3(str2double(gaze_cross_position(ii,2)),str2double(gaze_cross_position(ii,3)),str2double(gaze_cross_position(ii,4)),'k');
                 hold on;
%                     
                 %check for crosswalk buildings when user is on near side
                                ...
                                scatter3(str2double(gaze_cross_position(ii,2)),str2double(gaze_cross_position(ii,3)),str2double(gaze_cross_position(ii,4)),'g');
                                hold on;
                %check for crosswalk buildings when user is on far side
                                    ...
                                    scatter3(str2double(gaze_cross_position(ii,2)),str2double(gaze_cross_position(ii,3)),str2double(gaze_cross_position(ii,4)),'y');
                                    hold on;
                ...
                %untagged buildings
                                     ...
                                     scatter3(str2double(gaze_cross_position(ii,2)),str2double(gaze_cross_position(ii,3)),str2double(gaze_cross_position(ii,4)),'m');
                              hold on;
                                else
                                scatter3(str2double(gaze_cross_position(ii,2)),str2double(gaze_cross_position(ii,3)),str2double(gaze_cross_position(ii,4)),'c');
                                hold on;
                                end
                            end
                        end
